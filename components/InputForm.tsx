    ...
    try {
      const response = await fetch("/api/data", {
        ...
        body: JSON.stringify({
          name: inputName,
          img: inputImg,
          typeId: Number(inputType),
          countryId: Number(inputCountry),
          rating: inputRating,
          desc: inputDesc,
          ingredient: { items: inputIngredient },
  ...
  return (
    ...
    >
      ...
      <div className=" flex space-x-3">
        ...
        >
          <OptionList data={data.data.type} />
        </select>
      </div>
      <div className=" flex space-x-3">
        ...
        >
          <OptionList data={data.data.country} />
        </select>
      </div>
      <input
        className=" px-2 py-1"
      ...
      <textarea
        ...
        onChange={(e: any) => setInputIngredient(e.target.value)}
        cols={30}
        rows={3}
